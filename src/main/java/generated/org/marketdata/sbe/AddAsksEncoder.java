...
public final class AddAsksEncoder
{
    ...
    private final AddAsksEncoder parentMessage = this;
    ...
    public AddAsksEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public AddAsksEncoder wrapAndApplyHeader(
    ...
    public static final class AsksEncoder
    {
        ...
        private final AddAsksEncoder parentMessage;
        private MutableDirectBuffer buffer;
        private int count;
        private int index;
        private int offset;
        ...
        AsksEncoder(final AddAsksEncoder parentMessage)
        {
