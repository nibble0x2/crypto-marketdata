...
public final class OrderbookMsgEncoder
{
    ...
    private final OrderbookMsgEncoder parentMessage = this;
    ...
    public OrderbookMsgEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public OrderbookMsgEncoder wrapAndApplyHeader(
    ...
    public OrderbookMsgEncoder symbol(final int index, final byte value)
    {
        if (index < 0 || index >= 20)
        {
    ...
    public OrderbookMsgEncoder putSymbol(final byte[] src, final int srcOffset)
    {
        final int length = 20;
    ...
    public OrderbookMsgEncoder symbol(final String src)
    {
        final int length = 20;
    ...
    public OrderbookMsgEncoder symbol(final CharSequence src)
    {
        final int length = 20;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public OrderbookMsgEncoder firstUpdateId(final long value)
    {
    ...
    public OrderbookMsgEncoder lastUpdateId(final long value)
    {
    ...
    public static final class BidsEncoder
    {
        ...
        private final OrderbookMsgEncoder parentMessage;
        private MutableDirectBuffer buffer;
        private int count;
        private int index;
        private int offset;
        ...
        BidsEncoder(final OrderbookMsgEncoder parentMessage)
        {
    ...
    public static final class AsksEncoder
    {
        ...
        AsksEncoder(final OrderbookMsgEncoder parentMessage)
        {
            this.parentMessage = parentMessage;
        }
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        final OrderbookMsgDecoder decoder = new OrderbookMsgDecoder();
