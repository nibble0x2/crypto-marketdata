...
public final class OrderbookMsgDecoder
{
    ...
    private final OrderbookMsgDecoder parentMessage = this;
    ...
    public OrderbookMsgDecoder wrap(
    ...
    public OrderbookMsgDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public OrderbookMsgDecoder sbeRewind()
    {
        ...
        implements Iterable<BidsDecoder>, java.util.Iterator<BidsDecoder>
    {
        ...
        private final OrderbookMsgDecoder parentMessage;
        private DirectBuffer buffer;
        private int count;
        private int index;
        private int offset;
        ...
        BidsDecoder(final OrderbookMsgDecoder parentMessage)
        {
        ...
        implements Iterable<AsksDecoder>, java.util.Iterator<AsksDecoder>
    {
        ...
        AsksDecoder(final OrderbookMsgDecoder parentMessage)
        {
            this.parentMessage = parentMessage;
        }
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[OrderbookMsg](sbeTemplateId=");
        ...
        builder.append('|');
        builder.append("firstUpdateId=");
        builder.append(this.firstUpdateId());
        builder.append('|');
    ...
    public OrderbookMsgDecoder sbeSkip()
    {
        sbeRewind();
